...
app.use(cors({
  origin: ['https://veegify-web.web.app', 'http://localhost:3000', 'https://panel.vegiffyy.com', 'https://vendor.vegiffyy.com', 'https://vegiffyvendordelete.vercel.app', 'https://vegiffydeliveryboydeleteurl.vercel.app'],  // Allow both URLs
  methods: ['GET', 'POST'],
  credentials: true
}));
